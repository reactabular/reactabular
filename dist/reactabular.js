...
/***/ function(module, exports, __webpack_require__) {
	...
	var _editors = __webpack_require__(162);
	...
	var _formatters = __webpack_require__(163);
	...
	var _transforms = __webpack_require__(164);
	...
	var Provider = function (_React$Component) {
	  ...
	  _createClass(Provider, [{
	    ...
	    value: function getChildContext() {
	      ...
	      return {
	        columns: columns,
	        components: (0, _merge2.default)({}, _types.tableDefaults.components, components),
	        data: data,
	        rowKey: rowKey
	      };
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stack = __webpack_require__(5),
	    ...
	    copyArray = __webpack_require__(71),
	    copySymbols = __webpack_require__(72),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var stubArray = __webpack_require__(74);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseKeysIn = __webpack_require__(108),
	    indexKeys = __webpack_require__(57),
	    isIndex = __webpack_require__(68),
	    isPrototype = __webpack_require__(69);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isIterateeCall = __webpack_require__(112),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toFinite = __webpack_require__(116);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HeaderRow = function HeaderRow(_ref) {
	  ...
	  return _react2.default.createElement(components.row, {}, row.map(function (column, j) {
	    ...
	    var transformed = (0, _utils.evaluateTransforms)(transforms, label, extraParameters);
	    ...
	    return _react2.default.createElement(components.cell, _extends({
	      key: j + '-header'
	    }, (0, _utils.mergeProps)([transformed, props, columnProps])), transformed.children || format(label, extraParameters));
	  }));
	};
	HeaderRow.propTypes = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.mergeClassNames = exports.mergeProps = exports.evaluateTransforms = exports.resolveBodyColumns = exports.countRowSpan = exports.resolveHeaderRows = undefined;
	...
	function mergeProps(propCollections) {
	  var collections = propCollections.filter(function (a) {
	    return a;
	  });
	
	  return _merge2.default.apply(null, collections.concat([mergeAllClassNames(collections)]));
	}
	
	function mergeAllClassNames(propCollections) {
	  var ret = propCollections.reduce(function (all, props) {
	    var className = mergeClassNames(all.className, props.className);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _get = __webpack_require__(124);
	...
	var BodyRow = function BodyRow(_ref) {
	  ...
	  return _react2.default.createElement(components.row, rowProps, (0, _utils.resolveBodyColumns)(columns).map(function (column, j) {
	    ...
	    return _react2.default.createElement(components.cell, _extends({
	      key: j + '-cell'
	    }, (0, _utils.mergeProps)([transformed, props, columnProps])), transformed.children || format(resolve(value, extraParameters), extraParameters));
	  }));
	};
	BodyRow.propTypes = {
	  columns: _react2.default.PropTypes.array.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _find = __webpack_require__(137);
	...
	var sorter = function sorter() {
	  ...
	  var columns = _ref3$columns === undefined ? {} : _ref3$columns;
	  ...
	  return function (data) {
	    ...
	    sortingColumns.forEach(function (_ref4) {
	      var property = _ref4.property;
	      var sort = _ref4.sort;
	      // eslint-disable-line no-shadow
	      var realColumn = (0, _find2.default)(columns, { cell: { property: property } });
	      var resolver = realColumn && realColumn.cell && realColumn.cell.resolve || function (a) {
	        return a;
	      };
