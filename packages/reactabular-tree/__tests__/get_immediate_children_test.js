...
import { getImmediateChildren } from '../src';

describe('tree.getImmediateChildren', function () {
  ...
  it('returns an empty array if there are no children', function () {
    ...
    expect(getImmediateChildren({ index: 0 })(given)).to.deep.equal(expected);
  });
  ...
  it('works with nested children', function () {
    ...
    expect(getImmediateChildren({ index: 1 })(given)).to.deep.equal(expected);
  });
  ...
  it('allows parent field to be customized', function () {
    ...
    expect(getImmediateChildren({ index: 1, parentField })(given)).to.deep.equal(expected);
  });
  ...
  it('allows id field to be customized', function () {
    ...
    expect(getImmediateChildren({ index: 1, idField })(given)).to.deep.equal(expected);
  });
});
